...
Email confirmation environment variables for Brevo:
...
The backend sends a confirmation email through Brevo when an admin changes a reservation status to `confirmed`.
